...
with open('train.csv','rb') as csvfile:
    ...
    # print lstpm10[1]
     ...
     while i < len(lstpm) :
         ...
         xd10_3.insert(i,float(lstpmSO[i][5]))
         xd10_4.insert(i,float(lstpmSO[i][4]))
         ...
         xd10_9.insert(i,float(lstpmCO[i][5]))
         xd10_10.insert(i,float(lstpmCO[i][4]))
    ...
    # print yd
     ...
     for r in range(iteration):
      ...
      #   print w0_grad
      #   print w0_grad_n
         w1 = w1 -lr/w1_lr * w1_grad - rate * w1_grad_n
         w2 = w2 -lr/w2_lr * w2_grad - rate * w2_grad_n
         w3 = w3 -lr/w3_lr * w3_grad - rate * w3_grad_n
         w4 = w4 -lr/w4_lr * w4_grad - rate * w4_grad_n
         w5 = w5 -lr/w5_lr * w5_grad - rate * w5_grad_n
         w6 = w6 -lr/w6_lr * w6_grad - rate * w6_grad_n
         w7 = w7 -lr/w7_lr * w7_grad - rate * w7_grad_n
         w8 = w8 -lr/w8_lr * w8_grad - rate * w8_grad_n
         w00 = w00 -lr/w00_lr * w00_grad - rate * w00_grad_n
         w01 = w01 -lr/w01_lr * w01_grad - rate * w01_grad_n
         w02 = w02 -lr/w02_lr * w02_grad - rate * w02_grad_n
         w03 = w03 -lr/w03_lr * w03_grad - rate * w03_grad_n
         w04 = w04 -lr/w04_lr * w04_grad - rate * w04_grad_n
         w05 = w05 -lr/w05_lr * w05_grad - rate * w05_grad_n
         w06 = w06 -lr/w06_lr * w06_grad - rate * w06_grad_n
         w07 = w07 -lr/w07_lr * w07_grad - rate * w07_grad_n
         w08 = w08 -lr/w08_lr * w08_grad - rate * w08_grad_n
         w09 = w09 -lr/w09_lr * w09_grad - rate * w09_grad_n
         w10 = w10 -lr/w10_lr * w10_grad - rate * w10_grad_n
         w11 = w11 -lr/w11_lr * w11_grad - rate * w11_grad_n
...
with open('test_X.csv','rb') as csvfile:
    ...
    # print lstpm110[1]
     ...
     while q < len(lstpm) :
         ...
         xd_10.insert(q,float(lstpmCO[q][4]))
         xd_11.insert(q,float(lstpmWD[q][8]))
         q+=1

     id = ['id','value']
     f= open('test_x_cono1121new35_1.csv','w')
     w=csv.writer(f)
     w.writerow(id)
     for n in range(len(xd_0)):
